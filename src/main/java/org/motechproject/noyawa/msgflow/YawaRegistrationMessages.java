...
public class YawaRegistrationMessages {		
    ...
    public final String afterWhatsappSms = "Thank you, you have successfully registered into No Yawa reproductive health program. You will recieve programs messages every Wednesday and Saturday,";
    ...
    public final String LongCodeSuccess = "Congrats, you have been successfully registered into No Yawa program, to recieve messages via whatsapp SEND 'w' or SEND 's' to recieve messages via SMS to 0546687715";
